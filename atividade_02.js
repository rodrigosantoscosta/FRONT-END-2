...
for(let i = 0; i < 3; i++){
    ...
    altura = parseFloat(altura);//Certificando que some um numero na hora de fazer a media, lembrar de estudar as conversões de tipo corretamente para formatação para logging
    alturas.push(altura);
